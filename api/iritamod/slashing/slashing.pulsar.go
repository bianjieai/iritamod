...
func init() {
	...
	md_ValidatorSigningInfo = File_iritamod_slashing_slashing_proto.Messages().ByName("ValidatorSigningInfo")
...
func (x *ValidatorSigningInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_iritamod_slashing_slashing_proto_msgTypes[0]
...
func (x *fastReflection_ValidatorSigningInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "iritamod.slashing.ValidatorSigningInfo.address":
		return x.Address != ""
	case "iritamod.slashing.ValidatorSigningInfo.start_height":
		return x.StartHeight != int64(0)
	case "iritamod.slashing.ValidatorSigningInfo.index_offset":
		return x.IndexOffset != int64(0)
	case "iritamod.slashing.ValidatorSigningInfo.jailed_until":
		return x.JailedUntil != nil
	case "iritamod.slashing.ValidatorSigningInfo.tombstoned":
		return x.Tombstoned != false
	case "iritamod.slashing.ValidatorSigningInfo.missed_blocks_counter":
		return x.MissedBlocksCounter != int64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: iritamod.slashing.ValidatorSigningInfo"))
		}
		panic(fmt.Errorf("message iritamod.slashing.ValidatorSigningInfo does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ValidatorSigningInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message iritamod.slashing.ValidatorSigningInfo does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ValidatorSigningInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "iritamod.slashing.ValidatorSigningInfo.address":
		panic(fmt.Errorf("field address of message iritamod.slashing.ValidatorSigningInfo is not mutable"))
	case "iritamod.slashing.ValidatorSigningInfo.start_height":
		panic(fmt.Errorf("field start_height of message iritamod.slashing.ValidatorSigningInfo is not mutable"))
	case "iritamod.slashing.ValidatorSigningInfo.index_offset":
		panic(fmt.Errorf("field index_offset of message iritamod.slashing.ValidatorSigningInfo is not mutable"))
	case "iritamod.slashing.ValidatorSigningInfo.tombstoned":
		panic(fmt.Errorf("field tombstoned of message iritamod.slashing.ValidatorSigningInfo is not mutable"))
	case "iritamod.slashing.ValidatorSigningInfo.missed_blocks_counter":
		panic(fmt.Errorf("field missed_blocks_counter of message iritamod.slashing.ValidatorSigningInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: iritamod.slashing.ValidatorSigningInfo"))
		}
...
func (x *fastReflection_ValidatorSigningInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in iritamod.slashing.ValidatorSigningInfo", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_iritamod_slashing_slashing_proto_init()
	md_Params = File_iritamod_slashing_slashing_proto.Messages().ByName("Params")
...
func (x *Params) slowProtoReflect() protoreflect.Message {
	mi := &file_iritamod_slashing_slashing_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "iritamod.slashing.Params.signed_blocks_window":
		return x.SignedBlocksWindow != int64(0)
	case "iritamod.slashing.Params.min_signed_per_window":
		return len(x.MinSignedPerWindow) != 0
	case "iritamod.slashing.Params.downtime_jail_duration":
		return x.DowntimeJailDuration != nil
	case "iritamod.slashing.Params.slash_fraction_double_sign":
		return len(x.SlashFractionDoubleSign) != 0
	case "iritamod.slashing.Params.slash_fraction_downtime":
		return len(x.SlashFractionDowntime) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: iritamod.slashing.Params"))
		}
		panic(fmt.Errorf("message iritamod.slashing.Params does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Params) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message iritamod.slashing.Params does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "iritamod.slashing.Params.signed_blocks_window":
		panic(fmt.Errorf("field signed_blocks_window of message iritamod.slashing.Params is not mutable"))
	case "iritamod.slashing.Params.min_signed_per_window":
		panic(fmt.Errorf("field min_signed_per_window of message iritamod.slashing.Params is not mutable"))
	case "iritamod.slashing.Params.slash_fraction_double_sign":
		panic(fmt.Errorf("field slash_fraction_double_sign of message iritamod.slashing.Params is not mutable"))
	case "iritamod.slashing.Params.slash_fraction_downtime":
		panic(fmt.Errorf("field slash_fraction_downtime of message iritamod.slashing.Params is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: iritamod.slashing.Params"))
		}
...
func (x *fastReflection_Params) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in iritamod.slashing.Params", d.FullName()))
	}
	panic("unreachable")
}
...
func (*ValidatorSigningInfo) Descriptor() ([]byte, []int) {
	return file_iritamod_slashing_slashing_proto_rawDescGZIP(), []int{0}
}
...
func (*Params) Descriptor() ([]byte, []int) {
	return file_iritamod_slashing_slashing_proto_rawDescGZIP(), []int{1}
}
...
var file_iritamod_slashing_slashing_proto_rawDesc = []byte{
	0x0a, 0x20, 0x69, 0x72, 0x69, 0x74, 0x61, 0x6d, 0x6f, 0x64, 0x2f, 0x73, 0x6c, 0x61, 0x73, 0x68,
	0x69, 0x6e, 0x67, 0x2f, 0x73, 0x6c, 0x61, 0x73, 0x68, 0x69, 0x6e, 0x67, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x12, 0x11, 0x69, 0x72, 0x69, 0x74, 0x61, 0x6d, 0x6f, 0x64, 0x2e, 0x73, 0x6c, 0x61,
	...
	,
	...
	0x62, 0x73, 0x74, 0x6f, 0x6e, 0x65, 0x64, 0x12, 0x54, 0x0a, 0x15, 0x6d, 0x69, 0x73, 0x73, 0x65,
	0x64, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x42, 0x20, 0xf2, 0xde, 0x1f, 0x1c, 0x79, 0x61, 0x6d, 0x6c,
	0x3a, 0x22, 0x6d, 0x69, 0x73, 0x73, 0x65, 0x64, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x5f,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72, 0x22, 0x52, 0x13, 0x6d, 0x69, 0x73, 0x73, 0x65, 0x64,
	...
	0xba, 0x01, 0xc8, 0xe1, 0x1e, 0x00, 0x0a, 0x15, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x72, 0x69, 0x74,
	0x61, 0x6d, 0x6f, 0x64, 0x2e, 0x73, 0x6c, 0x61, 0x73, 0x68, 0x69, 0x6e, 0x67, 0x42, 0x0d, 0x53,
	0x6c, 0x61, 0x73, 0x68, 0x69, 0x6e, 0x67, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x29,
...
var (
	file_iritamod_slashing_slashing_proto_rawDescOnce sync.Once
	file_iritamod_slashing_slashing_proto_rawDescData = file_iritamod_slashing_slashing_proto_rawDesc
)

func file_iritamod_slashing_slashing_proto_rawDescGZIP() []byte {
	file_iritamod_slashing_slashing_proto_rawDescOnce.Do(func() {
		file_iritamod_slashing_slashing_proto_rawDescData = protoimpl.X.CompressGZIP(file_iritamod_slashing_slashing_proto_rawDescData)
	})
	return file_iritamod_slashing_slashing_proto_rawDescData
}

var file_iritamod_slashing_slashing_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_iritamod_slashing_slashing_proto_goTypes = []interface{}{
	(*ValidatorSigningInfo)(nil),  // 0: iritamod.slashing.ValidatorSigningInfo
	(*Params)(nil),                // 1: iritamod.slashing.Params
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),   // 3: google.protobuf.Duration
}
var file_iritamod_slashing_slashing_proto_depIdxs = []int32{
	2, // 0: iritamod.slashing.ValidatorSigningInfo.jailed_until:type_name -> google.protobuf.Timestamp
	3, // 1: iritamod.slashing.Params.downtime_jail_duration:type_name -> google.protobuf.Duration
...
func init() { file_iritamod_slashing_slashing_proto_init() }
func file_iritamod_slashing_slashing_proto_init() {
	if File_iritamod_slashing_slashing_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_iritamod_slashing_slashing_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_iritamod_slashing_slashing_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Params); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_iritamod_slashing_slashing_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_iritamod_slashing_slashing_proto_goTypes,
		DependencyIndexes: file_iritamod_slashing_slashing_proto_depIdxs,
		MessageInfos:      file_iritamod_slashing_slashing_proto_msgTypes,
	}.Build()
	File_iritamod_slashing_slashing_proto = out.File
	file_iritamod_slashing_slashing_proto_rawDesc = nil
	file_iritamod_slashing_slashing_proto_goTypes = nil
	file_iritamod_slashing_slashing_proto_depIdxs = nil
}
