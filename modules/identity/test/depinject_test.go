...
import (
	...
	identityapi "github.com/bianjieai/iritamod/api/iritamod/identity/module/v1"
	_ "github.com/bianjieai/iritamod/modules/identity"
...
var (
	...
	genesisModuleOrder = []string{
		...
		vestingtypes.ModuleName, consensustypes.ModuleName, identitytypes.ModuleName,
	}
	...
	moduleAccPerms = []*authmodulev1.ModuleAccountPermission{
		...
		{Account: identitytypes.ModuleName},
	}
	...
	AppConfig = appconfig.Compose(&appv1alpha1.Config{
		Modules: []*appv1alpha1.ModuleConfig{
			...
			},
			{
				...
				Config: appconfig.WrapAny(&identityapi.Module{}),
			},
		},
	})
)
