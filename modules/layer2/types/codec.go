...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	...
	cdc.RegisterConcrete(&MsgCreateL2BlockHeader{}, "iritamod/layer2/v1/MsgCreateL2Record", nil)
	...
	cdc.RegisterConcrete(&MsgUpdateClassesForNFT{}, "iritamod/layer2/v1/MsgUpdateClassesForNFT", nil)
...
func RegisterInterfaces(registry types.InterfaceRegistry) {
	registry.RegisterImplementations((*sdk.Msg)(nil),
		&MsgCreateL2Space{},
		&MsgTransferL2Space{},
		&MsgCreateL2BlockHeader{},
		&MsgCreateNFTs{},
		&MsgUpdateNFTs{},
		&MsgDeleteNFTs{},
		&MsgUpdateClassesForNFT{},
