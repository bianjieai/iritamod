...
var (
	...
	ErrValidatorNameExists = sdkerrors.Register(
		ModuleName,
		3,
		"validator already exist for this validator name; must use new validator name",
	)
	ErrValidatorPubkeyExists = sdkerrors.Register(
		ModuleName,
		4,
		"validator already exist for this validator pubkey; must use new validator pubkey",
	)
