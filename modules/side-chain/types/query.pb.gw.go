...
func request_Query_BlockHeader_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq QueryBlockHeaderRequest
	var metadata runtime.ServerMetadata
...
var (
	pattern_Query_Space_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"iritamod", "side-chain", "v1", "spaces", "space_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SpaceOfOwner_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"iritamod", "side-chain", "v1", "spaces", "owner"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BlockHeader_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"iritamod", "side-chain", "v1", "blockheaders", "space_id", "height"}, "", runtime.AssumeColonVerbOpt(false)))
)
